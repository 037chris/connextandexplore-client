...
export const EditComment = ({ isOpen, onClose, commentId, eventId }: EditCommentProps) => {
            ...
            body={
                <div className="flex flex-col gap-2">
                    <form className='flex flex-col gap-4' onSubmit={handleSubmit(onSubmit)}>
                        <Heading title='Bewertung und Rezension bearbeiten' subtitle='Ändere deine Gedanken!' />
                        <Input id="title" label='Titel *' disabled={loading} register={register} errors={errors} required />
                        <Input id="content" label='Inhalt *' disabled={loading} register={register} errors={errors} required />
